...
#let characteristic_impedance_of_vacuum = (
  val: 376.730313412,
  uncert: 5.9e-08,
  unit: "ohm",
  symbol: $Z_0$,
...
#let newtonian_constant_of_gravitation = (
  val: 6.6743e-11,
  uncert: 1.5e-15,
  unit: "m^3 kg^-1 s^-2",
  symbol: $G$,
...
#let newtonian_constant_of_gravitation_over_h-bar_c = (
  val: 6.70883e-39,
  uncert: 1.5e-43,
  unit: "(GeV/c^2)^-2",
  symbol: $G \/ planck c$,
...
#let planck_constant_in_ev_per_hz = (
  val: 4.135667696e-15,
  uncert: none,
  unit: "eV Hz^-1",
  symbol: $h$,
...
#let planck_mass_energy_equivalent_in_gev = (
  val: 1.22089e+19,
...
#let reduced_planck_constant_in_ev_s = (
  val: 6.582119569e-16,
  uncert: none,
  unit: "eV s",
  symbol: $planck$,
...
#let vacuum_electric_permittivity = (
