...
#let atomic_mass_constant_energy_equivalent = (
...
#let atomic_mass_constant_energy_equivalent_in_mev = (
  val: 931.49410372,
  uncert: 2.9e-07,
  unit: " MeV",
  symbol: $m_upright(u) c^2$,
...
#let boltzmann_constant_in_ev_per_k = (
  val: 8.617333262e-05,
  uncert: none,
  unit: "eV K^-1",
  symbol: $k$,
...
#let boltzmann_constant_in_hz_per_k = (
  val: 20836619120.0,
  uncert: none,
  unit: "Hz K^-1",
  symbol: $k \/ h$,
...
#let boltzmann_constant_in_inverse_meter_per_kelvin = (
  val: 69.50348004,
  uncert: none,
  unit: "m^-1 K^-1",
  symbol: $k \/ h c$,
...
#let first_radiation_constant_for_spectral_radiance = (
  val: 1.191042972e-16,
  uncert: none,
  unit: "W m^2 sr^-1",
...
#let loschmidt_constant_27315_k_100_kpa = (
  val: 2.651645804e+25,
  uncert: none,
  unit: "m^-3",
  symbol: $n_0$,
...
#let loschmidt_constant_27315_k_101325_kpa = (
  val: 2.686780111e+25,
  uncert: none,
  unit: "m^-3",
  symbol: $n_0$,
...
#let molar_volume_of_ideal_gas_27315_k_100_kpa = (
  val: 0.02271095464,
  uncert: none,
  unit: "m^3 mol^-1",
  symbol: $V_upright(m)$,
...
#let molar_volume_of_ideal_gas_27315_k_101325_kpa = (
  val: 0.02241396954,
  uncert: none,
  unit: "m^3 mol^-1",
  symbol: $V_upright(m)$,
...
#let sackur-tetrode_constant_1_k_100_kpa = (
  val: -1.15170753496,
  uncert: 4.7e-10,
  unit: "none",
  symbol: $S_0 \/ R$,
...
#let sackur-tetrode_constant_1_k_101325_kpa = (
  val: -1.16487052149,
  uncert: 4.7e-10,
  unit: "none",
  symbol: $S_0 \/ R$,
...
#let wien_frequency_displacement_law_constant = (
  val: 58789257570.0,
  uncert: none,
  unit: "Hz K^-1",
  symbol: $b^prime$,
...
#let wien_wavelength_displacement_law_constant = (
  val: 0.002897771955,
  uncert: none,
  unit: "m K",
  symbol: $b$,
