...
#let alpha_particle_relative_atomic_mass = (
  val: 4.001506179129,
  uncert: 6.2e-11,
  unit: "none",
  symbol: none,
...
#let atomic_mass_unit-electron_volt_relationship = (
  val: 931494103.72,
  uncert: 0.29,
  unit: "eV",
  symbol: none,
...
#let atomic_mass_unit-hartree_relationship = (
  val: 34231776.922,
  uncert: 0.011,
  unit: "E_h",
  symbol: none,
...
#let atomic_mass_unit-hertz_relationship = (
...
#let atomic_mass_unit-inverse_meter_relationship = (
...
#let atomic_mass_unit-joule_relationship = (
...
#let atomic_mass_unit-kelvin_relationship = (
...
#let atomic_unit_of_electric_dipole_mom = (
...
#let atomic_unit_of_electric_quadrupole_mom = (
...
#let atomic_unit_of_mag_dipole_mom = (
...
#let atomic_unit_of_mag_flux_density = (
  val: 235051.757077,
  uncert: 7.3e-05,
  unit: "T",
  symbol: none,
...
#let deuteron-electron_mag_mom_ratio = (
  val: -0.000466434555,
  uncert: 1.2e-12,
  unit: "none",
  symbol: none,
...
#let deuteron_mag_mom_to_bohr_magneton_ratio = (
  val: 0.0004669754568,
  uncert: 1.2e-12,
  unit: "none",
  symbol: none,
...
#let deuteron_mag_mom_to_nuclear_magneton_ratio = (
  val: 0.8574382335,
  uncert: 2.2e-09,
  unit: "none",
  symbol: none,
...
#let deuteron-neutron_mag_mom_ratio = (
  val: -0.44820652,
  uncert: 1.1e-07,
  unit: "none",
  symbol: none,
...
#let deuteron-proton_mag_mom_ratio = (
  val: 0.3070122093,
  uncert: 7.9e-10,
  unit: "none",
  symbol: none,
...
#let deuteron_relative_atomic_mass = (
  val: 2.013553212544,
  uncert: 1.5e-11,
  unit: "none",
  symbol: none,
...
#let electron-deuteron_mag_mom_ratio = (
  val: -2143.9234921,
  uncert: 5.6e-06,
  unit: "none",
  symbol: none,
...
#let electron_gyromag_ratio_in_mhz_per_t = (
  val: 28024.9513861,
  uncert: 8.7e-06,
  unit: " MHz T^-1",
  symbol: none,
...
#let electron_mag_mom_to_bohr_magneton_ratio = (
...
#let electron_mag_mom_to_nuclear_magneton_ratio = (
  val: -1838.281971877,
  uncert: 3.2e-08,
  unit: "none",
  symbol: none,
...
#let electron-muon_mag_mom_ratio = (
  val: 206.7669881,
  uncert: 4.6e-06,
  unit: "none",
  symbol: none,
...
#let electron-neutron_mag_mom_ratio = (
  val: 960.92048,
  uncert: 0.00023,
  unit: "none",
  symbol: none,
...
#let electron-proton_mag_mom_ratio = (
  val: -658.21068789,
  uncert: 1.9e-07,
  unit: "none",
  symbol: none,
...
#let electron_relative_atomic_mass = (
...
#let electron_to_shielded_helion_mag_mom_ratio = (
  val: 864.05823986,
  uncert: 7e-07,
  unit: "none",
  symbol: none,
...
#let electron_to_shielded_proton_mag_mom_ratio = (
  val: -658.2275856,
  uncert: 2.7e-06,
  unit: "none",
  symbol: none,
...
#let electron_volt-atomic_mass_unit_relationship = (
...
#let electron_volt-hartree_relationship = (
...
#let electron_volt-hertz_relationship = (
...
#let electron_volt-inverse_meter_relationship = (
  val: 806554.3937,
  uncert: none,
  unit: "m^-1",
  symbol: none,
...
#let electron_volt-kelvin_relationship = (
  val: 11604.51812,
  uncert: none,
  unit: "K",
  symbol: none,
...
#let electron_volt-kilogram_relationship = (
  val: 1.782661921e-36,
  uncert: none,
  unit: "kg",
  symbol: none,
...
#let hartree-atomic_mass_unit_relationship = (
...
#let hartree-electron_volt_relationship = (
  val: 27.211386245981,
  uncert: 3e-11,
  unit: "eV",
  symbol: none,
...
#let hartree-hertz_relationship = (
...
#let hartree-inverse_meter_relationship = (
  val: 21947463.136314,
  uncert: 2.4e-05,
  unit: "m^-1",
  symbol: none,
...
#let hartree-joule_relationship = (
...
#let hartree-kelvin_relationship = (
  val: 315775.02480398,
  uncert: 3.4e-07,
  unit: "K",
  symbol: none,
...
#let hartree-kilogram_relationship = (
...
#let helion_mag_mom_to_bohr_magneton_ratio = (
...
#let helion_mag_mom_to_nuclear_magneton_ratio = (
  val: -2.1276253498,
  uncert: 1.7e-09,
  unit: "none",
  symbol: none,
...
#let helion_relative_atomic_mass = (
  val: 3.014932246932,
  uncert: 7.4e-11,
  unit: "none",
  symbol: none,
...
#let hertz-atomic_mass_unit_relationship = (
  val: 4.439821659e-24,
  uncert: 1.4e-33,
  unit: "u",
  symbol: none,
...
#let hertz-electron_volt_relationship = (
  val: 4.135667696e-15,
  uncert: none,
  unit: "eV",
  symbol: none,
...
#let hertz-hartree_relationship = (
...
#let hertz-inverse_meter_relationship = (
  val: 3.335640951e-09,
  uncert: none,
  unit: "m^-1",
  symbol: none,
...
#let hertz-kilogram_relationship = (
  val: 7.372497323e-51,
  uncert: none,
  unit: "kg",
  symbol: none,
...
#let inverse_meter-atomic_mass_unit_relationship = (
...
#let inverse_meter-electron_volt_relationship = (
  val: 1.239841984e-06,
  uncert: none,
  unit: "eV",
  symbol: none,
...
#let inverse_meter-hartree_relationship = (
...
#let inverse_meter-hertz_relationship = (
  val: 299792458,
  uncert: none,
  unit: "Hz",
  symbol: none,
...
#let inverse_meter-joule_relationship = (
  val: 1.986445857e-25,
  uncert: none,
  unit: "J",
  symbol: none,
...
#let inverse_meter-kelvin_relationship = (
  val: 0.01438776877,
  uncert: none,
  unit: "K",
  symbol: none,
...
#let inverse_meter-kilogram_relationship = (
  val: 2.210219094e-42,
  uncert: none,
  unit: "kg",
  symbol: none,
...
#let joule-atomic_mass_unit_relationship = (
  val: 6700535247.1,
  uncert: 2.1,
  unit: "u",
  symbol: none,
...
#let joule-electron_volt_relationship = (
  val: 6.241509074e+18,
  uncert: none,
  unit: "eV",
  symbol: none,
...
#let joule-hartree_relationship = (
...
#let joule-inverse_meter_relationship = (
  val: 5.034116567e+24,
  uncert: none,
  unit: "m^-1",
  symbol: none,
...
#let joule-kilogram_relationship = (
  val: 1.112650056e-17,
  uncert: none,
  unit: "kg",
  symbol: none,
...
#let kelvin-atomic_mass_unit_relationship = (
...
#let kelvin-electron_volt_relationship = (
  val: 8.617333262e-05,
  uncert: none,
  unit: "eV",
  symbol: none,
...
#let kelvin-hartree_relationship = (
...
#let kelvin-inverse_meter_relationship = (
  val: 69.50348004,
  uncert: none,
  unit: "m^-1",
  symbol: none,
...
#let kelvin-kilogram_relationship = (
  val: 1.536179187e-40,
  uncert: none,
  unit: "kg",
  symbol: none,
...
#let kilogram-atomic_mass_unit_relationship = (
...
#let kilogram-electron_volt_relationship = (
  val: 5.609588603e+35,
  uncert: none,
  unit: "eV",
  symbol: none,
...
#let kilogram-hartree_relationship = (
...
#let kilogram-hertz_relationship = (
  val: 1.356392489e+50,
  uncert: none,
  unit: "Hz",
  symbol: none,
...
#let kilogram-inverse_meter_relationship = (
  val: 4.524438335e+41,
  uncert: none,
  unit: "m^-1",
  symbol: none,
...
#let kilogram-joule_relationship = (
  val: 8.987551787e+16,
  uncert: none,
  unit: "J",
  symbol: none,
...
#let kilogram-kelvin_relationship = (
  val: 6.50965726e+39,
  uncert: none,
  unit: "K",
  symbol: none,
...
#let muon_mag_mom_to_bohr_magneton_ratio = (
  val: -0.00484197048,
  uncert: 1.1e-10,
  unit: "none",
  symbol: none,
...
#let muon_mag_mom_to_nuclear_magneton_ratio = (
  val: -8.89059704,
  uncert: 2e-07,
  unit: "none",
  symbol: none,
...
#let neutron-electron_mag_mom_ratio = (
  val: 0.00104066884,
  uncert: 2.4e-10,
  unit: "none",
  symbol: none,
...
#let neutron_gyromag_ratio_in_mhz_per_t = (
  val: 29.1646935,
  uncert: 6.9e-06,
  unit: " MHz T^-1",
  symbol: none,
...
#let neutron_mag_mom_to_bohr_magneton_ratio = (
  val: -0.00104187565,
  uncert: 2.5e-10,
  unit: "none",
  symbol: none,
...
#let neutron_mag_mom_to_nuclear_magneton_ratio = (
  val: -1.91304276,
  uncert: 4.5e-07,
  unit: "none",
  symbol: none,
...
#let neutron-proton_mag_mom_ratio = (
  val: -0.68497935,
  uncert: 1.6e-07,
  unit: "none",
  symbol: none,
...
#let neutron_relative_atomic_mass = (
  val: 1.00866491606,
  uncert: 4e-10,
  unit: "none",
  symbol: none,
...
#let neutron_to_shielded_proton_mag_mom_ratio = (
  val: -0.68499694,
  uncert: 1.6e-07,
  unit: "none",
  symbol: none,
...
#let proton_gyromag_ratio_in_mhz_per_t = (
  val: 42.577478461,
  uncert: 1.8e-08,
  unit: "MHz T^-1",
  symbol: none,
...
#let proton_mag_mom_to_bohr_magneton_ratio = (
  val: 0.0015210322023,
  uncert: 4.5e-13,
  unit: "none",
  symbol: none,
...
#let proton_mag_mom_to_nuclear_magneton_ratio = (
  val: 2.79284734463,
  uncert: 8.2e-10,
  unit: "none",
  symbol: none,
...
#let proton_mag_shielding_correction = (
  val: 2.56715e-05,
  uncert: 4.1e-09,
  unit: "none",
  symbol: none,
...
#let proton-neutron_mag_mom_ratio = (
  val: -1.45989802,
  uncert: 3.4e-07,
  unit: "none",
  symbol: none,
...
#let proton_relative_atomic_mass = (
  val: 1.0072764665789,
  uncert: 8.3e-12,
  unit: "none",
  symbol: none,
...
#let shielded_helion_gyromag_ratio = (
  val: 203789460.78,
  uncert: 0.18,
  unit: "s^-1 T^-1",
  symbol: none,
...
#let shielded_helion_gyromag_ratio_in_mhz_per_t = (
  val: 32.434100033,
  uncert: 2.8e-08,
  unit: "MHz T^-1",
  symbol: none,
...
#let shielded_helion_mag_mom_to_bohr_magneton_ratio = (
...
#let shielded_helion_mag_mom_to_nuclear_magneton_ratio = (
  val: -2.1274977624,
  uncert: 1.7e-09,
  unit: "none",
  symbol: none,
...
#let shielded_helion_to_proton_mag_mom_ratio = (
  val: -0.76176657721,
  uncert: 6.6e-10,
  unit: "none",
  symbol: none,
...
#let shielded_helion_to_shielded_proton_mag_mom_ratio = (
  val: -0.7617861334,
  uncert: 3.1e-09,
  unit: "none",
  symbol: none,
...
#let shielded_proton_gyromag_ratio = (
  val: 267515319.4,
  uncert: 1.1,
  unit: " s^-1 T^-1",
  symbol: none,
...
#let shielded_proton_gyromag_ratio_in_mhz_per_t = (
  val: 42.57638543,
  uncert: 1.7e-07,
  unit: " MHz T^-1",
  symbol: none,
...
#let shielded_proton_mag_mom_to_bohr_magneton_ratio = (
  val: 0.0015209931551,
  uncert: 6.2e-12,
  unit: "none",
  symbol: none,
...
#let shielded_proton_mag_mom_to_nuclear_magneton_ratio = (
  val: 2.792775648,
  uncert: 1.1e-08,
  unit: "none",
  symbol: none,
...
#let shielding_difference_of_d_and_p_in_hd = (
  val: 1.9877e-08,
  uncert: 1e-12,
  unit: "none",
  symbol: none,
...
#let shielding_difference_of_t_and_p_in_ht = (
  val: 2.3945e-08,
  uncert: 2e-12,
  unit: "none",
  symbol: none,
...
#let triton_mag_mom_to_bohr_magneton_ratio = (
  val: 0.0016223936648,
  uncert: 3.2e-12,
  unit: "none",
  symbol: none,
...
#let triton_mag_mom_to_nuclear_magneton_ratio = (
  val: 2.978962465,
  uncert: 5.9e-09,
  unit: "none",
  symbol: none,
...
#let triton_relative_atomic_mass = (
  val: 3.01550071597,
  uncert: 1e-10,
  unit: "none",
  symbol: none,
...
#let triton_to_proton_mag_mom_ratio = (
  val: 1.0666399189,
  uncert: 2.1e-09,
  unit: "none",
  symbol: none,
